...
if (_mouseOverType != "OBJECT") exitWith { [LSTRING(NothingSelected)] call FUNC(showMessage); };
if !(alive _mouseOverUnit) exitWith { ["str_a3_bis_fnc_modulearsenal_errordead"] call FUNC(showMessage); };
