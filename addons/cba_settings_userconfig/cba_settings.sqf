...
force ace_advanced_fatigue_swayFactor = 0.809564;
...
force ace_interact_menu_selectorColor = [1,0.84,0.19];
...
force ace_map_gestures_defaultLeadColor = [0.124777,0.88,1,0.95];
...
force ace_finger_indicatorColor = [1,0.84,0.19,0.85];
...
force ace_pylons_timePerPylon = 1.46308;
...
force acex_headless_endMission = 1;
...
force acre_sys_core_ts3ChannelPassword = "321";
...
force UPSL_aime_vehicle_seats_setting_getin_action = false;
...
// AWESome Cockpit
force orbis_cockpit_checklistUnits = "KM/H";
...
force diwako_dui_indicators_size = 0.7;
...
force diwako_dui_distanceWarning = 4;
...
force diwako_dui_radar_pointer_color = [1,0.84,0.19,1];
...
// Synixe Zeus
synixe_ui_zeus_displayACEMedical = true;
synixe_ui_zeus_displayACEMedicalLives = false;
synixe_ui_zeus_displayFPS = true;
synixe_ui_zeus_displayName = false;
synixe_ui_zeus_displayPlayerInfo = true;
synixe_ui_zeus_displayRadios = true;
synixe_ui_zeus_displayRole = true;
synixe_ui_zeus_displayTeam = true;
synixe_zeus_environmentSounds = true;
synixe_zeus_properPlacement = true;

// TAC Miscellaneous
force tac_bodybag_destroyChance = 0;
...
force zen_editor_removeWatermark = false;
